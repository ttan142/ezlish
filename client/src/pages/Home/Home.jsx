...
const Home = ({user}) => {
    ...
    useEffect(()=>{
       ...
       if(user)
         axios
           .get("https://ezlish-server.onrender.com/api/results/".concat(user._id), {
             params: { limit: 4 }
           })
           .then(
             (response) => {
         ...
         axios
           .get("https://ezlish-server.onrender.com/api/courses/by-user/".concat(user._id))
           .then(
             (response) => {
    ...
    return (
      ...
      <div className='body1'>
        ...
        <section className="home">
          ...
          <h1 className="info">Your current balance is {user.balance}$ in EZLISH</h1>
        </section>
