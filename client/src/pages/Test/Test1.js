...
function Test() {
  ...
  const handleTest = async ()=>{
     const  {data} = await axios.get('https://ezlish-server.onrender.com/api/questions/'.concat(state._id));
   ...
   useEffect(()=>{
     axios
       .get(`https://ezlish-server.onrender.com/api/comments/?testId=`.concat(state._id))
       .then((res) => {
