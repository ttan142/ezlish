...
const CreateTestForm = () => {
  ...
  const fetchTests = async () => {
    try {
      const response = await axios.get(
        "https://ezlish-server.onrender.com/api/test"
      );
  ...
  const updateTest = (e) => {
    ...
    axios
      .put(
        `https://ezlish-server.onrender.com/api/test/${selectedTest._id}`,
        updatedInfo
      )
      .then((response) => {
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setNumberQuestion(Number(e.target.value))
                            }
                          />
                        </div>
                        <div className="mb-3">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-3">
                      ...
                      <div className="page-range">
                        {indexOfFirstTest + 1}-
                        {Math.min(indexOfLastTest, sortedTests.length)} of{" "}
                        {sortedTests.length}
                      </div>
